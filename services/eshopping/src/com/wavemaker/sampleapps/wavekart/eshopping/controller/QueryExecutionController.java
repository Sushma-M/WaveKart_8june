...
public class QueryExecutionController {
    ...
    public Page<Object> execute_Total_InCart(@RequestParam(value = "LoggedinUserID", required = false) java.lang.Integer LoggedinUserID, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query _Total_InCart");
        Page<Object> result = queryService.execute_Total_InCart(pageable, LoggedinUserID);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    public Page<Object> execute_Total_Price(@RequestParam(value = "data", required = false) java.lang.String data, @RequestParam(value = "user", required = false) java.lang.Integer user, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query _Total_Price");
        Page<Object> result = queryService.execute_Total_Price(pageable, data, user);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
